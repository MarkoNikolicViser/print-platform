                        ...
                        <Card
                            ...
                            sx={{
                                ...
                                border: isSelected
                                    ...
                                    : '1px solid #e0e0e0',
                                opacity:
                                    template.pricing?.is_active === false ? 0.7 : 1,
                            }}
                        >
                            <CardActionArea onClick={() => onSelect(template)}>
                                <CardContent>
                                    ...
                                    >
                                        ...
                                        <Stack direction="row" spacing={1}>
                                            ...
                                            <Chip
                                                size="small"
                                                label={
                                                    template.has_pricing ? 'Edit' : 'Create'
                                                }
                                                color={
                                                    template.has_pricing
                                                        ? 'primary'
                                    ...
                                    <Typography
                                        ...
                                        mt={1}
                                        sx={{
                                            visibility: template.has_pricing
                                                ? 'visible'
                                                : 'hidden',
                                        }}
                                    >
                                        Base price:{' '}
                                        <strong>
                                            {template.pricing?.base_price ?? 0} RSD
                                        </strong>
                                    </Typography>
                                </CardContent>
                            </CardActionArea>
